...
| **E. Nhân sự VN (thu hẹp)** — ✅ **BUILT dev 2026-07-16** (`docs/spec/employee-vn-identity-fields.md`) | Custom fields Employee: Số CCCD + Số sổ BHXH; MST = `tax_id` sẵn có (+bản dịch). Không HĐLĐ (đã quyết định loại) | Hồ sơ nhân sự đủ định danh VN | Còn lại: deploy prod (fixtures, gộp Đợt A/T2) | — |
